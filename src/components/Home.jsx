...
const Home = () => {
  return (
    <div name="home" className="h-screen flex w-full bg-gradient-to-b from-black to bg-gray-800">
       ...
       <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
            ...
            <p className="text-gray-300 py-4 max-w-md">
                Currently Studying Web Programming Focusing On Backend using Laravel and Node JS. This is my attempt
        ...
        <div>
            <img src={Profpic} alt="My Profile" className="rounded-xl  mx-auto w-4/12 md:w-6/12"/>
        </div>
       </div>
       </div>
  )
